import './SidebarLeftBottom.css';
import SidebarLeftBottomSettingsItem from './SidebarLeftBottomSettingsItem/SidebarLeftBottomSettingsItem';
        ...
        <div className='sidebar-left-bottom'>
            <div className='sidebar-left-bottom-settings'>
                <div className='sidebar-left-bottom-settings-header'>
                    <div className='sidebar-left-bottom-settings-header-text'>
                        Settings
                    </div>
                </div>
                <div className='sidebar-left-bottom-settings-list'>
                    <SidebarLeftBottomSettingsItem 
                        icon = {icon_settings}
                        name = 'Settings'
                    />
                    <SidebarLeftBottomSettingsItem
...
export default SidebarLeftBottom;
const WatchedCardsItem = (props) => {
    const subject = props.subject;
    const total = props.total;
    const watched = props.watched;

    return ( 
        <div className='watched-cards-item'>
            <div className='watched-cards-item-icon'>
            ...
            <div className='watched-cards-item-details'>
                <div className='watched-cards-item-details-watched'>
                    {watched+'/'+total+' Watched'}
                </div>
                <div className='watched-cards-item-details-subject'>
                    {subject}
                </div>
            </div>
            <div className='watched-cards-item-overflow'>
...
export default WatchedCardsItem;
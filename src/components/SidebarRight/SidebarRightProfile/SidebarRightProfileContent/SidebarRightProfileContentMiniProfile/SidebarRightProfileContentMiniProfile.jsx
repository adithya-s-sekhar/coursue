import './SidebarRightProfileContentMiniProfile.css';

const SidebarRightProfileContentMiniProfile = (props) => {
    const image = props.image;
    const name = props.name;

    return ( 
        <div className='sidebar-right-profile-content-mini-profile'>
            <div className='sidebar-right-profile-content-mini-profile-circle'>
                <div className='sidebar-right-profile-content-mini-profile-circle-border'>
                    ...
                    <div className='sidebar-right-profile-content-mini-profile-circle-image-mask'>
                        <img src={image} />
                    </div>
                </div>
            </div>
            <div className='sidebar-right-profile-content-mini-profile-details'>
                <div className='sidebar-right-profile-content-mini-profile-details-greeting'>
                    {'Good Morning '+name}
                </div>
                <div className='sidebar-right-profile-content-mini-profile-details-advice'>
                    Continue your journey and achieve your target
                </div>
            </div>
            <div className='sidebar-right-profile-content-mini-profile-icons'>
                <div className='sidebar-right-profile-content-mini-profile-icons-item'>
...
export default SidebarRightProfileContentMiniProfile;